...
all:	imwcs delwcs xy2sky sky2xy imstar imrot i2f imgsc imujc
...
imstar: imstar.c $(LIBWCS) libwcs/fitshead.h libwcs/wcs.h
...
imwcs: imwcs.c $(LIBWCS) libwcs/fitshead.h
